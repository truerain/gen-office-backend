...
## Endpoints
### 1) 코드 그룹 목록 조회
- `GET /api/mis/admin/lookups/masters`
- Query params
  ...
  "items": [
    {
      ...
      "lastUpdatedAt": "2026-02-24T10:00:00"
    }
  ],
  "page": 0,
  "size": 20,
...
### 2) 코드 그룹 단건 조회
- `GET /api/mis/admin/lookups/masters/{lkupClssCd}`
...
### 3) 코드 그룹 생성
- `POST /api/mis/admin/lookups/masters`
...
### 4) 코드 그룹 수정
- `PUT /api/mis/admin/lookups/masters/{lkupClssCd}`
...
```json
{
  ...
  "lastUpdatedBy": "EMP001",
  "lastUpdatedByName": "홍길동",
  "lastUpdatedAt": "2026-02-24T10:05:00"
}
```
...
### 6) 상세 코드 목록 조회
- `GET /api/mis/admin/lookups/{lkupClssCd}/details`
- Query params
...
### 7) 상세 코드 단건 조회
- `GET /api/mis/admin/lookups/{lkupClssCd}/details/{lkupCd}`
...
### 8) 상세 코드 생성
- `POST /api/mis/admin/lookups/{lkupClssCd}/details`
...
### 9) 상세 코드 수정
- `PUT /api/mis/admin/lookups/{lkupClssCd}/details/{lkupCd}`
